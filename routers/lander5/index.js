// routers/lander5/index.js
const express = require("express");
const router = express.Router();
const crypto = require("crypto");
const payuClient = require("../../config/payU");

const orderModel5 = require("../../models/oderModel5");
...
/**
 * POST /api/lander5/create-order  (Razorpay path)
 */
...
/**
 * POST /api/lander5/create-order-abd
 */
...
/**
 * DELETE /api/lander5/delete-order-abd
 */
router.delete("/delete-order-abd", async (req, res) => {
  ...
  try {
    const result = await orderModel5Abd.deleteMany({ email });
...
/**
 * POST /api/lander5/create-order-phonepe  (PhonePe path)
 */
...
/**
 * GET /api/lander5/get-orders-abd
 */
...
/**
 * GET /api/lander5/get-email-sent  (unchanged, still works with Resend logs)
